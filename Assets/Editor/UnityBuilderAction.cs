...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Slot Lucky Classic";
        private static string COMPANY_NAME = "1691504999067330402912";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.slotlucky.classicenjoi";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "Dzenth";
        private static string KEY_ALIAS_NAME = "Dzenth";
        private static string KEY_ALIAS_PASS = "Dzenth";
